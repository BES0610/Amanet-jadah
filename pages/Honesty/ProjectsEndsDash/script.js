...
th3.textContent = " مستحقة";

let th4 = document.createElement("th");
th4.textContent = "منفذة ";

let th5 = document.createElement("th");
th5.textContent = "متبقية";
...
th7.textContent = "الاستشاري";

let th8 = document.createElement("th");
th8.textContent = "المقاول";
...
for (let i = startIndex; i < endIndex; i++) {
    ...
    bodyDiv.innerHTML = `
        <td style="cursor: pointer;"><a href="../ScoProjectsEndsDash/index.html">${item.projectname}</a></td>
        <td>${item.owner}</td>
        <td>${item.number1}</td>
        <td>${item.number2}</td>
        <td>${item.number3}</td>
